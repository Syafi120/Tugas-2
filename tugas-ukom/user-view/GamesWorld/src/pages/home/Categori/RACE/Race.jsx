...
import D1 from '../../../../assets/Img/nfs1.jpg';
import C1 from '../../../../assets/Img/cs2.jpg';
import C2 from '../../../../assets/Img/nfsheat.jpg';
...
const Race = () => {
  return (
    <div style={{backgroundColor: '#1e1e2f'}}>
        ...
        <h2 className='text-white mt-2' style={{ marginLeft: '92px' }}>RACING GAMES</h2>
                ...
                <div className="row mt-5 mx-auto" style={{ border: '1px solid #27293d', backgroundColor: '#27293d', heigh: '100px', width: '1000px' }}>
                    <div className="row">
                        ...
                        <div className="col-8 text-white ms-3">
                            <span style={{ fontSize: '20px' }}>NEED FOR SPEED HEAT</span>
