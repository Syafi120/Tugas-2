...
import D1 from '../../../../assets/Img/FPS/fpsgame.jpg';
...
const Fps = () => {
  return (
    <div style={{backgroundColor: '#1e1e2f'}}>
        ...
        <header>
            <a href="/apexlegend">
                <img src={D1} style={{ width: '1347px', marginTop: '60px', display: 'cover' }} alt="" />
            </a>
            <hr className='text-white'/>
        </header>
        <h2 className='text-white mt-2' style={{ marginLeft: '92px' }}>FPS GAMES</h2>
        ...
        <div className="container mt-5" style={{ width: '1200px' ,border: '1px solid  #395e8c', backgroundColor: ' #395e8c ', height: '60px' }}>
            <span>
                <ul className='d-flex'>
                    <li className='ms-1 btn'><a className='text-decoration-none btn text-white' style={{ backgroundColor: ' #06244b ' }} href="">Action</a></li>
                    <li className='ms-1 btn'><a className='text-decoration-none btn text-white' style={{ backgroundColor: ' #06244b ' }} href="">Adventure</a></li>
                    <li className='ms-1 btn'><a className='text-decoration-none btn text-white' style={{ backgroundColor: ' #06244b ' }} href="">RPG</a></li>
                    <li className='ms-1 btn'><a className='text-decoration-none btn text-white' style={{ backgroundColor: ' #06244b ' }} href="">MMORPG</a></li>
                    <li className='ms-1 btn'><a className='text-decoration-none btn text-white' style={{ backgroundColor: ' #06244b ' }} href="">FPS</a></li>
                    <li style={{ marginTop: '8px', marginLeft: '220px' }}>
                        <form className="d-flex" role="search">
                            <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" />
                            <button className="btn text-white" style={{ backgroundColor: '#06244b' }} type="submit">Search</button>
                        </form>
                    </li>
                </ul>
            </span>
        ...
        <header style={{ backgroundColor: ' #091b32 ' }}>
            <div className="container">
                    <div className="row mt-4 mx-auto" style={{ border: '1px solid #27293d', backgroundColor: '#27293d', heigh: '100px', width: '1000px' }}>
                        <div className="row">
                            <div className="col-2">
