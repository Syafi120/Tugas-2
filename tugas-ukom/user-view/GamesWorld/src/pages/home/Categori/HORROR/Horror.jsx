...
import D1 from '../../../../assets/Img/pamali/ppr2.jpg';
import C1 from '../../../../assets/Img/cs2.jpg';
import C2 from '../../../../assets/Img/pamali.jpg';
import C3 from '../../../../assets/Img/Dreadout/dreadout.jpg';
...
const Horror = () => {
  return (
    <div style={{backgroundColor: '#1e1e2f'}}>
        ...
        <header>
            <a href="/pamali">
                <img src={D1} style={{ width: '1349px', height: '400px' , marginTop: '60px', display: 'cover' }} alt="" />
            </a>
            <hr className='text-white'/>
        </header>
        <h2 className='text-white mt-2' style={{ marginLeft: '92px' }}>HORROR GAMES</h2>
                ...
                <div className="carousel-item active">
                    ...
                    <div className="row mx-auto">
                        <div className='col-2' style={{ marginLeft: '205px' }}>
                            <a href='/pamali' className='text-white text-decoration-none' >
                                <img src={C2} alt='' className='lofer'/>
                                <p className='teks'>Pamali</p>
                                <p className='descr'>text here</p>
                            </a>
                        </div>
                        <div className='col-2'>
                            <a href='/dreadout' className='text-white text-decoration-none' >
                                <img src={C3} alt='' className='lofer'/>
                                <p className='teks'>DreadOut</p>
                                <p className='descr'>text here</p>
                            </a>
                        </div>
                        <div className='col-2'>
        ...
        <div className="container">
                <div className="row mt-5 mx-auto" style={{ border: '1px solid #27293d', backgroundColor: '#27293d', heigh: '100px', width: '1000px' }}>
                    <div className="row">
                        ...
                        <div className="col-8 text-white ms-3">
                            <span style={{ fontSize: '20px' }}>PAMALI</span>
                ...
                <div className="row mt-2 mx-auto" style={{ border: '1px solid #27293d', backgroundColor: '#27293d', heigh: '100px', width: '1000px' }}>
                    <div className="row">
                        ...
                        <div className="col-8 text-white ms-3">
                            <span style={{ fontSize: '20px' }}>DREADOUT</span>
                            <p style={{ fontSize: '11px' }}>
                                <a href="#" className='text-decoration-none'>F2P </a> 
                                <a href="" className='text-decoration-none'>FPS </a> 
                                <a href="" className='text-decoration-none'>BATTLE ROYALE </a> 
                        ...
                        <div className="col">
                            <a href="/dreadout" className='btn mt-5' style={{ backgroundColor: '#1BAA05', marginLeft: '47px' }}>CHECK</a>
                        </div>
                    </div>
                </div>
                <div className="row mt-2 mx-auto" style={{ border: '1px solid #27293d', backgroundColor: '#27293d', heigh: '100px', width: '1000px' }}>
