...
import D1 from '../../../../assets/Img/coralisland/crl1.jpg';
import C1 from '../../../../assets/Img/cs2.jpg';
import C2 from '../../../../assets/Img/coralisland/coralisland.jpg';
...
const Farm = () => {
  return (
    <div style={{backgroundColor: '#1e1e2f'}}>
        ...
        <header>
            <a href="/coralisland">
                <img src={D1} style={{ width: '1349px', height: '300px' , marginTop: '60px', display: 'cover' }} alt="" />
            </a>
            <hr className='text-white'/>
        </header>
        <h2 className='text-white mt-2' style={{ marginLeft: '92px' }}>FARM-SIM GAMES</h2>
                    ...
                    <div className="row mx-auto">
                        <div className='col-2' style={{ marginLeft: '205px' }}>
                            <a href='/apexlegend' className='text-white text-decoration-none' >
                                ...
                                <p className='teks'>Coral Island</p>
                ...
                <div className="row mt-5 mx-auto" style={{ border: '1px solid #27293d', backgroundColor: '#27293d', heigh: '100px', width: '1000px' }}>
                    <div className="row">
                        ...
                        <div className="col-8 text-white ms-3">
                            <span style={{ fontSize: '20px' }}>CORAL ISLAND</span>
                        ...
                        <div className="col">
                            <a href="/coralisland" className='btn mt-5' style={{ backgroundColor: '#1BAA05', marginLeft: '47px' }}>CHECK</a>
                        </div>
                    </div>
                </div>
