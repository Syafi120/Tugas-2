...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnJumlah(View view){
        ...
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("")){
            Toast.makeText(this, "Bilangan Tambah Ada yang Kosong", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void btnKurang(View view){
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("")){
            Toast.makeText(this,"Bilangan Kurang Ada yang Kosong", Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void btnKali(View view){
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("")){
            Toast.makeText(this,"Bilangan Kali Ada yang Kosong",Toast.LENGTH_SHORT).show();
        }else {
    ...
    public void btnBagi(View view){
        if (etBil_1.getText().toString().equals("") || etBil_2.getText().toString().equals("")){
            Toast.makeText(this,"Bilangan Bagi Ada yang Kosong",Toast.LENGTH_SHORT).show();
        }else {
